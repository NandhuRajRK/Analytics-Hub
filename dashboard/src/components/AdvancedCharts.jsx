...
const AdvancedCharts = ({ projects, selectedPortfolio, selectedStatuses, sidebarCollapsed }) => {
  ...
  const addHighlightingFunctionality = () => {
    ...
    svg.selectAll('.portfolio-node, .program-node, .project-node').on('dblclick', () => {
      resetHighlighting();
    });
  };
            ...
            <div className="filters-section">
              <div className="filter-row">
                <div className="filter-group">
                  <label className="filter-label" htmlFor="portfolio-select">Portfolio:</label>
                  <select
                    id="portfolio-select"
            ...
            <div className="charts-section">
              <div className="charts-grid">
                <div className="chart-card">
                  ...
                  <div className="chart-content">
                    <div className="chart-main">
                      <svg className="chart-svg" ref={sankeyRef}></svg>
                      {!isSankeyAvailable && (
                ...
                <div className="chart-card">
                  ...
                  <div className="chart-content">
                    <div className="chart-main">
                      <svg className="chart-svg" ref={heatmapRef}></svg>
                    </div>
                ...
                <div className="chart-card">
                  ...
                  <div className="chart-content">
                    <div className="chart-main">
                      <svg className="chart-svg" ref={networkRef}></svg>
                    </div>
                ...
                <div className="chart-card">
                  ...
                  <div className="chart-content">
                    <div className="chart-main">
                      <svg className="chart-svg" ref={chart3dRef}></svg>
                    </div>
